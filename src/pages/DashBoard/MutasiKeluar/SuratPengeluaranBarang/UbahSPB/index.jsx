...
// Import actions
import {
  updateSuratPengeluaranBarangRequest,
...
const UbahSPB = () => {
  ...
  const handleSimpanClick = () => {
    ...
    console.log("Mengubah SPB:", spbData);
    dispatch(updateSuratPengeluaranBarangRequest(argument.id, spbData));
  };
