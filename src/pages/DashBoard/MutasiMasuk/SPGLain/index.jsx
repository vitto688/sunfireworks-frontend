...
import { TAMBAH_SPGLAIN_PATH } from "./TambahSPGLain";
import { UBAH_SPGLAIN_PATH } from "./UbahSPGLain";
...
const SPGLain = () => {
  ...
  const handleItemClick = (value) => {
    ...
    navigate(UBAH_SPGLAIN_PATH, { state: value });
  };
  ...
  return (
    <div className={styles.spgLainSection}>
      ...
      <div className={styles.spgLainTable}>
