...
export const printSPGBawang = (data, itemsPerPage = 7) => {
    ...
    for (let page = 0; page < totalPages; page++) {
      ...
      pagesHTML += `
        ...
        isFirstOnNewPaper ? "first-on-paper" : ""
          ...
          <div class="header">
            <h1>SURAT PENERIMAAN GUDANG (SPG) BAWANG</h1>
          </div>
  ...
  const htmlContent = `
      ...
      <head>
        ...
        <style>
          ...
          /* Column widths optimized for SPG Bawang documents */
          .col-kode { 
            width: 120px; 
            font-size: 9px;
            padding: 2px 1px;
  ...
  if (previewWindow) {
    ...
    const previewHtml = `
      ...
      <head>
        <meta charset="UTF-8">
        <title>Preview - SPG BAWANG</title>
        <style>
          body {
            margin: 0;
      ...
      <body>
        <div class="preview-container">
          <div class="preview-header">
            <h1 class="preview-title">Preview - Surat Penerimaan Gudang (SPG) Bawang</h1>
