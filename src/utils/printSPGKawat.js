...
export const printSPGKawat = (data, itemsPerPage = 7) => {
  ...
  const htmlContent = `
      ...
      <head>
        ...
        <style>
          ...
          /* Column widths optimized for SPG Kawat documents */
          .col-kode { 
            width: 120px; 
            font-size: 9px;
            padding: 2px 1px;
      ...
      <body>
        <div class="preview-container">
          <div class="preview-header">
            <h1 class="preview-title">Preview - Surat Penerimaan Gudang (SPG) Kawat</h1>
