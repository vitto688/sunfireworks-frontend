...
export const printSuratJalan = (data, itemsPerPage = 6) => {
  ...
  const htmlContent = `
      ...
      <head>
        ...
        <style>
          ...
          @media print {
            ...
            * {
            ...
            .page-container.first-page {
              height: 5.5in !important; /* First page is 5.47 inches */
            }
          ...
          .page-container.first-page {
            height: 5.5in; /* First page is 5.43 inches tall */
          }
  ...
  if (previewWindow) {
    ...
    const previewHtml = `
      ...
      <head>
        <meta charset="UTF-8">
        <title>Preview - SURAT JALAN</title>
        <style>
          body {
            margin: 0;
      ...
      <body>
        <div class="preview-container">
          <div class="preview-header">
            <h1 class="preview-title">Preview - Surat Jalan</h1>
